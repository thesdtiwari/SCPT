      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 lg:col-span-3">
            <h6 className="text-gray-800 font-medium mb-2">Developer</h6>
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Saurabh Tiwari</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 lg:col-span-3">
            ...
            {/* flex justify-between flex-wrap */}
              <li className="mb-2">
                <a href="https://www.iitism.ac.in/iitismnew/" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Home</a>
              </li>
              <li className="mb-2">
                <a href="https://cdc.iitism.ac.in/" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">About us</a>
              </li>
              <li className="mb-2">
                <a href="https://cdc.iitism.ac.in/files/2022.pdf" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Placement stats</a>
              </li>
            </ul>
          </div>
